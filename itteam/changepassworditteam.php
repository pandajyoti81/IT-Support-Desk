    ...
    <div class="container-xxl position-relative bg-white d-flex p-0">
        ...
        <div class="content">
            ...
            <nav class="navbar navbar-expand bg-light navbar-light sticky-top px-4 py-0">
                ...
                <span class='btn btn-primary'>Manage / Change Password</span>
                ...
                <div class="row g-4">
                    <div class="col-sm-12 col-xl-12">
                        <div class="bg-light rounded h-100 p-4">
                            ...
                            <form action="updateitteampassword.php" method="post">
                                <div class="mb-3">
                                ...
                                <a href="changepassworditteam.php" type="reset" class="btn btn-primary">Cancel</a>
                            </form>
                        </div>
                    </div>
                </div>
